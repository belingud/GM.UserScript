...
Allows users to paste an image directly from the clipboard as an input source for reverse image search, alongside the existing Select File, Paste URL, and Click Image options.
